...
"""
Use this component to generate a default building typology for a commercial building to be used with the "Dragonfly_UWG Parameters from Typologies" component.  This default typology is based on the OpenStudio template of an open office and will automatically assign constructions based on the connected _climateZone.
-
...
def main(flr2Flr, glzRatio, climateZone, df_textGen):
    ...
    typology = df_textGen.defaultCommTypology(flr2Flr, glzRatio, climateZoneNum, wallVegFraction, roofVegFraction)
